...
#############################################################################################
#СПИСКИ
#сами по себе списки являются коллекцией не самих элементов, а ссылок на эти элементы в памяти.
#элементы списка могут хранить в себе совершенно разные значения. Неважно будь то числа, строки и т. д.
...
#метод добавления элементов – EXTEND,перебирает все символы, которые
# ему передали и добавит их в список по отдельности.
# и позволяет внести в наш список другой список
names = ['Python', 'C', 'C++', 'Assembler', 'java']
print(names)
names.extend('urban')
print(names)
names.extend(['urban', True, 39])
print(names)
...
#проверить есть ли конкретный элемент в нашем списке - команда IN
#отсутствие элемента - команда NOT IN
print('Python' in names)        #ответ True, элемент в списке
print('ORION' not in names )    #ответ True, элемента нет списке

#СРЕЗЫ

names = ['Python', 'C', 'C++', 'Assembler', 'java']
print(names[1:4])       # Выводит со ВТОРОГО!! по ТРЕТИЙ!! элемент списка
print(names[0:5:2])     # Выводит каждый второй (шаг 2) элемент указанного ДИАПАЗОНА списка (с 0 по 4)


#########################################################################################
#Основы f-строк
#В Python строки, созданные с помощью f'' (или f""), называются f-строками (formatted string literals).
# Они позволяют встраивать выражения в строки, что делает их очень удобными для форматирования строк.
# Вот несколько примеров использования f-строк:

name = "Alice"
age = 30
message = f"Hello, {name}! You are {age} years old."
print(message)
#В этом примере {name} и {age} будут заменены значениями переменных name и age соответственно.

#Выражения в f-строках
#Вы можете использовать выражения внутри фигурных скобок:
