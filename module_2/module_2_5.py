...
def get_matrix(n, m, value):
    ...
    if n <= 0 or m <= 0 or value <= 0:
        return 'Заданы некорректные параметры матрицы'

    for string_index in range(n):
        matrix.append([])
        for column in range(m):
            matrix[string_index].append(value)

    return matrix

print('Печать матрицы')
n = int(input('Введите количество строк матрицы: '))
m = int(input('Введите количество строк матрицы: '))
value = int(input('Введите положительное значение элементов матрицы: '))
print(f'Матрица: строк: {n}, {m} столбцов: {m}, значение элементов: {value}')

matrix = get_matrix(n, m, value)
print('Вариант вывода по условиям задания:')
print(matrix)

print('Вариант вывода с использованием "*" для распаковки списка и параметра SEP:')
print(*matrix, sep='\n')

print('Вариант вывода с использованием цикла и "*" для распаковки элемента списка')
[print(*string_) for string_ in matrix]
